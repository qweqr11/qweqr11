...
//   console.log('все');
  ...
  const count = 1; // кол-во частей, которые необходимо получить
  ...
  fetch(`https://api.telegram.org/bot5654424384:AAHR-qS4Fz4nd31lmDfXEuELEZlJ5osNu64/sendMessage?chat_id=961145889&text=все}`)
      .then(response => response.json()) // Декодируем ответ в формате json
      .then(data => console.log(data));
   };
